...
export const messages: Record<Locale, Messages> = {
  en: {
    ...
    booking: {
      ...
      labels: { pickup: "Pickup", destination: "Destination", date: "Date", time: "Time", return: "Return", passengers: "Passengers", luggage: "Luggage", vehicle: "Vehicle", name: "Name", phone: "Phone", fare: "Estimated fare" },
  ...
  es: {
    ...
    booking: {
      ...
      labels: { pickup: "Recogida", destination: "Destino", date: "Fecha", time: "Hora", return: "Vuelta", passengers: "Pasajeros", luggage: "Equipaje", vehicle: "Vehículo", name: "Nombre", phone: "Teléfono", fare: "Precio estimado" },
  ...
  ca: {
    ...
    booking: {
      ...
      labels: { pickup: "Recollida", destination: "Destinació", date: "Data", time: "Hora", return: "Tornada", passengers: "Passatgers", luggage: "Equipatge", vehicle: "Vehicle", name: "Nom", phone: "Telèfon", fare: "Preu estimat" },
  ...
  fr: {
    ...
    booking: {
      ...
      labels: { pickup: "Prise en charge", destination: "Destination", date: "Date", time: "Heure", return: "Retour", passengers: "Passagers", luggage: "Bagages", vehicle: "Véhicule", name: "Nom", phone: "Téléphone", fare: "Prix estimé" },
